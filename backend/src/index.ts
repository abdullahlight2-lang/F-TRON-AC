...
const rootHtmlPath = join(import.meta.dir, '../../index.html');
...
const app = new Elysia()
  ...
  // Serve Frontend Single-Page Application HTML directly at root '/'
  .get('/', async ({ set }) => {
    try {
      const file = Bun.file(rootHtmlPath);
    ...
    return 'F TRON AC Backend Server Connected & Running!';
  })
...
console.log(`🌐 Serving Connected Landing Page at http://localhost:3001`);
console.log(`📚 Swagger API Docs available at http://localhost:3001/swagger`);
